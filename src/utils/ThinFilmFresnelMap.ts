...
export class ThinFilmFresnelMap extends THREE.DataTexture {
  ...
  updateSettings(filmThickness: number, refractiveIndexFilm: number, refractiveIndexBase: number) {
